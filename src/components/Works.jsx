    ...
    return (
      ...
      >
        ...
        >
          ...
          <div className='mt-5 '>
            <h3 className='font-bold text-white-200 text-[24px]'>{name}</h3>
    ...
    <>
      ...
      <div className='w-full flex'>
          ...
          >
              ...
              Each project is briefly described with links to the code repositories and live demos in it. It reflects
